  ...
  public: {
    Tables: {
      ...
      marketplace_interactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "marketplace_interactions_recommendation_id_fkey"
        ...
        Relationships: [
          {
            ...
            columns: ["analysis_id"]
            isOneToOne: false
            referencedRelation: "satellite_analyses"
            referencedColumns: ["id"]
          },
          {
      ...
      satellite_analyses: {
        Row: {
          ...
          field_id: string
          gee_task_id: string | null
          health_status: string | null
          id: string
          msavi2_value: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "satellite_analyses_field_id_fkey"
            columns: ["field_id"]
            isOneToOne: false
            referencedRelation: "fields"
            referencedColumns: ["id"]
    ...
    Enums: {
      ...
      crop_type:
        ...
        | "tomato"
        | "other"
      field_status: "active" | "fallow" | "harvested" | "planted"
